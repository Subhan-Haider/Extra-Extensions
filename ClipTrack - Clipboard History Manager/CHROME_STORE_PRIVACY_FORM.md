# Chrome Web Store Privacy Form - ClipTrack - Clipboard History Manager
...
This extension serves a single, well-defined purpose: advanced clipboard history manager with favorites, tags, export, statistics, and more! The extension does not perform any unrelated functions and all requested permissions are strictly necessary to fulfill this core functionality.
...
**Other permissions:**
- **clipboardRead**: Required to read clipboard content when the user explicitly requests to paste data into the extension.
- **clipboardWrite**: Required to copy processed content to the clipboard for easy user access and workflow integration.
- **activeTab**: Required to access the currently active tab when the user clicks the extension icon, enabling the extension to read and modify the current page's content only when explicitly invoked.
...
**Privacy policy URL:**
https://github.com/YOUR_USERNAME/ClipTrack---Clipboard-History-Manager/blob/main/PRIVACY_POLICY.md

(Please update this URL with your actual privacy policy location)

---

**Generated for:** ClipTrack - Clipboard History Manager v2.0.0
**Last Updated:** 2.0.0 release
