# Chrome Web Store Privacy Form - LootOps: Epic & Steam Games
...
This extension serves a single, well-defined purpose: tactical hud for free games. lootops tracks every free loot drop from epic games and steam. The extension does not perform any unrelated functions and all requested permissions are strictly necessary to fulfill this core functionality.
...
Required to schedule periodic tasks such as checking for updates, refreshing data, or triggering time-based notifications to ensure the extension functions properly in the background.

**notifications justification:**
Required to display desktop notifications to alert users about important events, updates, or completed tasks, enhancing user awareness and engagement.
...
**Privacy policy URL:**
https://github.com/YOUR_USERNAME/LootOps:-Epic-&-Steam-Games/blob/main/PRIVACY_POLICY.md
