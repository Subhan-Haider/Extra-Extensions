# Chrome Web Store Privacy Form - GhostType AI
...
This extension serves a single, well-defined purpose: the ultimate undetectable ai typing engine. perfect for bypass and high-speed automation. The extension does not perform any unrelated functions and all requested permissions are strictly necessary to fulfill this core functionality.
...
**Other permissions:**
- **scripting**: Required to inject JavaScript or CSS into web pages to modify content, add features, or enhance user experience.
...
**Privacy policy URL:**
https://github.com/YOUR_USERNAME/GhostType-AI/blob/main/PRIVACY_POLICY.md
