...
1. Visit the Chrome Web Store page for Humanize AI
...
- **sidePanel**: Required for core functionality
- **declarativeNetRequest**: Required for core functionality

### Host Permissions
- `https://deceptioner.site/*`: Required to access and modify content on these pages
